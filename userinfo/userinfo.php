...
echo "User IP: ", $user_ip; // Output IP address [Ex: 177.87.193.134]
...
echo "<BR>";
echo "Continent: ",  $details->continent_name;
echo "<BR>";
echo "Latitute: ",  $details->latitude;
echo "<BR>";
